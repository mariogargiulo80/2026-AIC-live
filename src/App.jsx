...
import { BarChart3, Users, MapPin, Save, Clock, Trophy, RefreshCcw } from "lucide-react";
import "./App.css";
          ...
          return (
            <div className="resultRow" key={l.id}>
              <div className="resultTop">
                ...
                <span>{votes} voti · {pct(votes, totals.totalVotes)}%</span>
              </div>
              <div className="bar">
                <div
                  style={{
      ...
      <section className="card">
        ...
        {totals.prefTotals.slice(0, 12).map((c, i) => (
          <div className="rank" key={c.id}>
            <div>
              <b>#{i + 1} {c.name}</b>
              <span>{lists.find(l => l.id === c.list)?.name}</span>
            </div>
